...
trait ApiResponseTrait
{
    ...
    /**
     * Response returned in success case with status code 200
     */
    ...
    public function errorResponse(string $message = '', int $code = 400)
    {
        ...
        throw new HttpResponseException(response($response, $code));
//        return response(['message' => $message], $code);
    ...
    public function validationResponse($validator): void
    {
        ...
        throw new HttpResponseException(response($response, Response::HTTP_UNPROCESSABLE_ENTITY));
    }
    ...
    {
        $this->errorResponse('Invalid Token', Response::HTTP_UNAUTHORIZED);
    }
