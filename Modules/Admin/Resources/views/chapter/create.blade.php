...
@section('title') إضافة باب @endsection
@section('css')
...
@section('content')
 @component('admin::common-components.breadcrumb')
         @slot('title') الأبواب  @endslot
         @slot('li_1') إضافة باب  @endslot
 @endcomponent
 @if($errors->any())
 ...
 @endif
 <form method="POST" action="{{route('admin.chapter.store')}}" enctype="multipart/form-data"  data-parsley-validate novalidate>
     @csrf
     @method('POST')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            <label class="control-label">عنوان الباب</label>
