...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{route('admin.chapter.insert',$id)}}">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button-list">
                                        <a href="{{route('admin.chapter.edit',$row->id)}}">
                                ...
                                <td>
                                    <div class="button-list">
                                        <form class="delete" data-id="{{$row->id}}" method="POST" action="{{ route('admin.chapter.destroy',[$row->id]) }}">
                                            @csrf
                                            {{ method_field('DELETE') }}
