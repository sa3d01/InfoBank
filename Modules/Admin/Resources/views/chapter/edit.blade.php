...
@section('title') تعديل باب @endsection
@section('css')
...
@section('content')
 ...
 @endif
 <form method="POST" action="{{route('admin.chapter.update',$row->id)}}" enctype="multipart/form-data" data-parsley-validate novalidate>
     @csrf
     @method('PUT')
        <div class="row">
            <div class="col-lg-12">
